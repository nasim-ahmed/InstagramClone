...
class LoginController:UIViewController{
    ...
    let logoContainerView: UIView = {
        ...
        let logoImageView = UIImageView(image: #imageLiteral(resourceName: "DuoSnap_logo_white"))
    ...
    @objc func handleTextInputChange(){
        ...
        if isFormValid{
            ...
            loginButton.backgroundColor = UIColor.rgb(red: 74, green: 164, blue: 237)
        } else{
    ...
    override func viewDidLoad() {
        ...
        dontHaveAccountButton.anchor(top: nil, left: view.leftAnchor, bottom: view.bottomAnchor, right: view.rightAnchor, paddingTop: 0, paddingLeft: 0, paddingRight: 0, paddingBottom: 0, width: 0, height: 50)
